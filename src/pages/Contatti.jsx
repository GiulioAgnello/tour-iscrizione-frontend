    ...
    <>
      <div className="page-hero">
        <div className="container">
          <h1>Contatti</h1>
          <p>Hai domande sull'evento? Scrivici, ti risponderemo il prima possibile.</p>
        </div>
      </div>
        ...
        <div className="container contatti-wrap">
            ...
            <div className="contatti-info__items">
              <div className="contatti-info__item">
                ...
                <div>
                  ...
                  <span>Francesco Gs — 328.9675151</span>
                </div>
              </div>
              <div className="contatti-info__item">
                <span className="contatti-info__icon">🏁</span>
          ...
          <div className="contatti-form-wrap">
            ...
            {status === 'success' ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="contatti-form">
                <div className="form-group">
                  <label className="form-label">Nome <span className="required">*</span></label>
                  <input className={`form-input ${errors.nome ? 'error' : ''}`}
                    type="text" value={form.nome} onChange={set('nome')} placeholder="Il tuo nome" />
                ...
                <div className="form-group">
                  ...
                  <input className={`form-input ${errors.email ? 'error' : ''}`}
                    type="email" value={form.email} onChange={set('email')} placeholder="la-tua@email.com" />
                  {errors.email && <span className="form-error">{errors.email}</span>}
                </div>

                <div className="form-group">
                  <label className="form-label">Messaggio <span className="required">*</span></label>
                  <textarea className={`form-textarea ${errors.messaggio ? 'error' : ''}`}
                    value={form.messaggio} onChange={set('messaggio')}
                    placeholder="Scrivi la tua domanda o richiesta…" rows={5} />
                  {errors.messaggio && <span className="form-error">{errors.messaggio}</span>}
                </div>
                ...
                <button type="submit" className="btn btn--primary contatti-submit"
